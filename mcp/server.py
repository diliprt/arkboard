...
Talks JSON-RPC over stdin/stdout (Cursor local MCP) and forwards tools/* to the
Arkboard app HTTP endpoint at http://127.0.0.1:7420/mcp.

Requires the Arkboard macOS app to be running.
"""
        ...
        try:
            if method == "initialize":
                result = {
                    ...
                    "capabilities": {"tools": {}},
                    "serverInfo": {"name": "arkboard-bridge", "version": "1.0.0"},
                }
